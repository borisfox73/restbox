...
## Version 0.1.0
* python version currently is for example-only
* updated frontend code for the latest Angular1 version
* edit part now placed into different page/controller, funcions overlap is possible
* updated Arduino code to be more interactive
* npm and bower modules versions updated and freezed till the next release
