...
//	public class SpringTestConfig {	}
    ...
    void 'get status b1 led 0'() {
        // rfunc1
        // inline
        getStatus('b1', 'cisco123', 'led', 0, 1, true)
        // stored
        getStatus('b1', 'cisco123', 'led', 0, 1)
    }
    ...
    void 'get status b1 led 1'() {
        // rfunc2
        // inline
        getStatus('b1', 'cisco123', 'led', 1, 0, true)
        // stored
        getStatus('b1', 'cisco123', 'led', 1, 0)
    }
    ...
    void 'get status b2 led 1'() {
        // rfunc4
        // inline
        getStatus('b2', 'cisco456', 'led', 1, 0, true)
        // stored
