...
//		return Mono.just(ErrorResponse.create("Access is denied", HttpStatus.FORBIDDEN, ex));
	...
	public Mono<RestApiException> handleConstraintViolationExceptionException(@NonNull final ConstraintViolationException ex) {
		log.debug("constraintviolation exception caught");
	...
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	public Mono<RestApiException> handleServerWebInputException(@NonNull final ServerWebInputException ex) {
